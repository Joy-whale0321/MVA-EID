...
int Fun4All_G4_sPHENIX(
    ...
    const string &outputFile_str = "/sphenix/user/weihuma/RunOutput/G4sPHENIX_K+_eta0-1.1_7-9GeV_400",
   // const string &outputFile_str = "/sphenix/user/weihuma/RunOutput/G4sPHENIX_e-_eta0-1.1_2-12GeV_random_test_single3",
    ...
    const string &outdir = ".")
{
  ...
  char outputFile[500];
  sprintf(outputFile,"%s_0%d", outputFile_str.c_str(), process);
  ...
  if (Input::SIMPLE)
  {
    INPUTGENERATOR::SimpleEventGenerator[0]->add_particles(321, 1);
    ...
    INPUTGENERATOR::SimpleEventGenerator[0]->set_pt_range(7.0, 9.);
  }
  // Upsilons
